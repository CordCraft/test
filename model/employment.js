...
employmentSchema.statics.create = function(callback){
    this.save(callback);
};


employmentSchema.statics.update = function(employmentId, accessorId, callback){
    
};


employmentSchema.statics.delete = function(employmentId, accessorId, callback){
    
};


employmentSchema.statics.findByUserId = function(userId, accessorId, callback){
...
employmentSchema.statics.findByUserIds = function(userIds, accessorId, callback){
...
employmentSchema.statics.findByProximityZero = function(userId, accessorId, callback){
...
employmentSchema.statics.findByProximityFirst = function(userId, accessorId, callback){
...
employmentSchema.statics.findByProximitySecond = function(userId, accessorId, callback){
...
employmentSchema.statics.findByProximityThird = function(userId, accessorId, callback){
...
employmentSchema.statics.findByProximity = function(userId, callback){
